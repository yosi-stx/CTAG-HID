...
bool_reset = a(1:x1,3);
% OuterHandleFULLValue = a(1:x1,3);
% OuterHandleFULLValue = OuterHandleFULLValue * max(a(1:x1,2)) / max(OuterHandleFULLValue);
...
% plot((1:x1),OuterHandleFULLValue,'-oc')  % bool_reset
