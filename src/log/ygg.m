% with graphical indication of FW clicker recognition
% a = csvread('C:\Work\Python\CTAG_HID\src\log\clicker_log.csv');
% a = csvread('C:\Work\Yosi\CTAG-HID_Graph\src\log\clicker_log.csv');
a = csvread('clicker_log.csv');
figure(1)
hold off
% x1=100;
x1=length(a);
...
% b = csvread('C:\Work\Yosi\CTAG-HID_Graph\src\log\clicker_overSample.csv');
b = csvread('clicker_overSample.csv');
% figure(2)
...
% 2020_09_24__15_22
plot(diff(b(:,3))*4000,'m-o');
s = csvread('clicker_sound.csv');
plot(s(:,1),'g-o');
